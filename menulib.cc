/* automatically generated from L1Menu_Collisions2018_v0_0_0 with menu2lib.py */
...
bool
CaloCaloCorrelation_14252454238452343999
(L1Analysis::L1AnalysisL1UpgradeDataFormat* data)
{
    bool pass = false;
  size_t nobj0 = 0;
  for (size_t ii = 0; ii < data->egBx.size(); ii++)
  {
    ...
    nobj0++;
        ...
        bool etaWindow1;
                              // EG40: ET >= 80 at BX = 0
      if (not (data->egIEt.at(ii) >= 80)) continue;
...
bool
L1_EG40er2p1_Tau20er2p1_dR_Min0p3(L1Analysis::L1AnalysisL1UpgradeDataFormat* data, L1Analysis::L1AnalysisL1CaloTowerDataFormat* calo_tower)
{
  return CaloCaloCorrelation_14252454238452343999(data);
}
bool
...
bool
L1_EXT_HCAL_LaserMon_1(L1Analysis::L1AnalysisL1UpgradeDataFormat* data, L1Analysis::L1AnalysisL1CaloTowerDataFormat* calo_tower)
{
  return SingleEXT_14860848214295529384(data);
}
bool
L1_EXT_HCAL_LaserMon_4(L1Analysis::L1AnalysisL1UpgradeDataFormat* data, L1Analysis::L1AnalysisL1CaloTowerDataFormat* calo_tower)
{
...
{
  return SingleMU_17416443806824820063(data) and ( not SingleEXT_6909925150529645533(data)) and ( not SingleEXT_6102799243448260461(data)) and ( not SingleEXT_6909925150529645277(data));
}
bool
...
{
  return SingleMU_17416443858364427615(data) and ( not SingleEXT_6909925150529645533(data)) and ( not SingleEXT_6102799243448260461(data)) and ( not SingleEXT_6909925150529645277(data));
}
bool
...
AlgorithmFunction getFuncFromName(const std::string& name)
{
  ...
  {
    std::stringstream ss;
    ss << "fat> algorithm '" << name << "' is not defined in L1Menu_Collisions2018_v0_0_0\n";
